        ...
        private IMapper AutoMapper(Ninject.Activation.IContext context)
        {
            Mapper.Initialize(config =>
            {
                ...
                config.CreateMap<Lesson, LessonDetailsDTO>()
                    .ForMember(dest => dest.AcademicGroupName, opt => opt.MapFrom(src => src.AcademicGroup.GroupName))
                    .ForMember(dest => dest.BuildingId, opt => opt.MapFrom(src => src.Classroom.BuildingId))
                    ...
                    .ForMember(dest => dest.SubjectTypeId, opt => opt.MapFrom(src => src.Subject.SubjectTypeId));
