...
{
    public class LessonPagedSpecification : PagedBaseSpecification<Lesson>
    {
        public LessonPagedSpecification(string facultyTitle, string subjectName, string subjectTypeName,
